...
RUN apt-get update -y && apt-get install \
    python3-dev python3-sphinx vim nano bash-completion unzip wget file desktop-file-utils git sudo make cmake=3.28.3 swig g++ gfortran doxygen graphviz texlive-latex-base \
